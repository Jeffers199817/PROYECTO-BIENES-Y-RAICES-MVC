<main class="contenedor  seccion contenido-centrado">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source srset="/build/img/blog3.webp" type=" image/webp">
        
                    <source srset="/build/img/blog3.jpg" type=" image/jpg">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source srset="/build/img/blog4.webp" type=" image/webp">
        
                    <source srset="/build/img/blog4.jpg" type=" image/jpg">
